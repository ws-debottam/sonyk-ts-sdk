...
describe("Assets", () => {
    test("listAgentAssets", async () => {
        ...
        const rawResponseBody = {
            ...
            data: [
                {
                    pk_asset_id: 123,
                    fk_agent_id: "agent_abc123def456",
                    type: "FILE",
        ...
        server
            .mockEndpoint()
            .get("/api/developer/assets/agent_abc123def456")
            .respondWith()
            .statusCode(200)
    ...
    test("getAgentAssetDetails", async () => {
        ...
        server
            .mockEndpoint()
            .get("/api/developer/assets/agentId/1")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();
    ...
    test("updateAgentAsset", async () => {
        ...
        server
            .mockEndpoint()
            .put("/api/developer/assets/agentId/1")
    ...
    test("deleteAgentAsset", async () => {
        ...
        server
            .mockEndpoint()
            .delete("/api/developer/assets/agentId/1")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();
    ...
    test("createAgentTextAsset", async () => {
        ...
        server
            .mockEndpoint()
            .post("/api/developer/assets/agentId/text")
            .jsonBody(rawRequestBody)
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
    ...
    test("getAgentAssetContent", async () => {
        ...
        server
            .mockEndpoint()
            .get("/api/developer/assets/agentId/1/content")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();
    ...
    test("searchAgentAssets", async () => {
        ...
        server
            .mockEndpoint()
            .post("/api/developer/assets/agentId/search")
            .jsonBody(rawRequestBody)
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
