...
describe("Agents", () => {
    ...
    test("getAgent", async () => {
        ...
        server
            .mockEndpoint()
            .get("/api/developer/agents/agent_abc123def456")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();
    ...
    test("updateAgent", async () => {
        ...
        server
            .mockEndpoint()
            .put("/api/developer/agents/agentId")
            .jsonBody(rawRequestBody)
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
    ...
    test("deleteAgent", async () => {
        ...
        server
            .mockEndpoint()
            .delete("/api/developer/agents/agentId")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();
    ...
    test("getAgentTools", async () => {
        ...
        server
            .mockEndpoint()
            .get("/api/developer/agents/agentId/tools")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();
    ...
    test("assignToolToAgent", async () => {
        ...
        server
            .mockEndpoint()
            .post("/api/developer/agents/agentId/tools")
            .jsonBody(rawRequestBody)
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
    ...
    test("unassignToolFromAgent", async () => {
        ...
        server
            .mockEndpoint()
            .delete("/api/developer/agents/agentId/tools")
            .jsonBody(rawRequestBody)
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
